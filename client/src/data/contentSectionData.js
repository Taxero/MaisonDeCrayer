import { Wifi, Car, Coffee, Dumbbell, Sparkles, HeadphonesIcon as Concierge, Crown, Shield } from 'lucide-react';
...
export const amenities = [
  ...
  // { icon: Sparkles, name: "Wellness Spa", description: "Relaxing treatments and massages" },
  { icon: Concierge, name: "Concierge Service", description: "Personalized assistance" }
];
